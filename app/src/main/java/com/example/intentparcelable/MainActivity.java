    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Arif Rachmat Darmawan");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Arif Rachmat Darmawan");
                mPerson.setAge(17);

                mPerson.setEmail("rrdarmawan11@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082260245744";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == MoveForResultActivity.RESULT_CODE) {
                ...
                tvResult.setText(String.format("Hasil Nya : %s", selectedValue));
            }
        }
    }
}